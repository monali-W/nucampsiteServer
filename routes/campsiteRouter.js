    ...
    Campsite.findById(req.params.campsiteId)
      ...
      .then(campsite => {
        ...
        if (campsite && currentComment) {
          ...
          //req.user{ fn, ln, ad, _id}
          let currentCommentAuthorId = currentComment.author._id;
          //currentCOmmentAuthor{_id, fn, ln, ad}
          if (currentCommentAuthorId.equals(loggdInUserId)) {
            if (req.body.rating) {
